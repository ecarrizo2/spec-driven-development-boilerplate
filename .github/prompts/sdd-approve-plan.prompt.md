---
name: sdd-approve-plan
description: Stamp a plan as approved — verifies all PENDING markers are resolved, sets approval fields in manifest.yaml, transitions task-graph status, and commits the change to the plan branch.
---
