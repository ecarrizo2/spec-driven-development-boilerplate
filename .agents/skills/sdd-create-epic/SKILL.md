...
description: Start an interactive product discovery session to define a new cross-repo epic — transforms a rough product brief, PRD, or feature idea into a structured epic document with acceptance criteria and a Definition of Done.
---
...
1. **If you provided a product brief** (PRD, Slack message, idea) in your message — restate it to confirm understanding, then begin Phase 1.
2. **If the brief is vague** — ask one clarifying question before starting: "What user or business problem does this solve?"
3. **If no brief provided** — ask: "Please share the product brief, PRD, or description of the feature/project you'd like to turn into an epic."

Begin the discovery session only after you understand the goal.
