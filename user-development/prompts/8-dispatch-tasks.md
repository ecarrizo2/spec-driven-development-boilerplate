...
> the `sdd-dispatch-tasks` skill activates automatically. In VS Code, use `/sdd-dispatch-tasks`.
>
...
>
> **Prerequisite:** Epic exists in `epics/`, task-graph is confirmed, request files are refined (status: `refined`).
