...
> the `sdd-slim-docs` skill activates automatically. In VS Code, use `/sdd-slim-docs`.
>
> **📋 Fallback:** Copy-paste the content below into any agent conversation.

---

# Prompt: Slim Documentation

> **Usage:** Copy this prompt into a new agent conversation. Provide the target documentation folder path when asked.
