...
2. Enrich `manifest.yaml` with `agent_generated` metadata
3. Append discovery summary to `specification.md`
4. Commit updates back to the same `plan/*` branch
5. Publish check run: **Plan Generated by Agent**
6. Update PR comment with pickup status
